...
;		03		23feb10	add quad version to process four pixels at once
;
;		Mandelbrot 64-bit assembler
; 
...
proc_frame	Mandelbrot64
		test	rcx, 3			; Width a multiple of four?
		jz		Mandelbrot64Q	; yes, process four pixels at once
...
iloop:
		...
		test	rax, rax		; both pixels escaped?
...
iloopq:
		...
		ADDPD	xmm1, xmm6		; xmm1 = 2 * zx * zy + b
		ADDPD	xmm9, xmm6		; xmm9 = 2 * zx * zy + b

		SUBPD	xmm0, xmm3		; xmm0 = zx ^ 2 - zy ^ 2
		SUBPD	xmm8, xmm11		; xmm8 = zx ^ 2 - zy ^ 2
		...
		ADDPD	xmm0, xmm4		; xmm0 = zx ^ 2 - zy ^ 2 + a
		ADDPD	xmm8, xmm12		; xmm8 = zx ^ 2 - zy ^ 2 + a
