...
IMPLEMENT_DYNCREATE(CSizingDockFrame, CMiniDockFrameWnd);
...
BEGIN_MESSAGE_MAP(CSizingDockFrame, CMiniDockFrameWnd)
...
{
	int	retc = CMiniDockFrameWnd::OnCreate(lpCreateStruct);
	if (!retc) {
