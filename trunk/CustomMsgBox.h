...
//
	static	int	MsgBox(
		...
		const LPCTSTR *Button = NULL,	// Array of pointers to text strings,
								// one per button; if an element is NULL, the
								// corresponding button keeps its default text
		int		Buttons = 0	// Number of elements in button text array.
	);
...
private:
	...
	static	int		m_Buttons;	// Number of elements in button text array.
};
