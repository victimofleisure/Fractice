...
public:
	...
	void	Refresh();
	bool	Rename();
	static	bool	RenameFile(HWND hWnd, LPCTSTR OldName, LPCTSTR NewName, FILEOP_FLAGS Flags = FOF_SILENT);
...
// Types
	...
	typedef CArrayEx<POSITION, POSITION> CPosArray;
...
// Helpers
	...
	static	bool	FormatSize(ULONGLONG Size, CString& Str);
};
