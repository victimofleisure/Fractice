...
void CEngine::CRenderer::MandelbarFPU()
{
...
void CEngine::CRenderer::MandelbarGMP()
{
...
#if _MFC_VER > 0x0600
#ifdef _WIN64
void CEngine::CRenderer::MandelbarSSE2()
{
	PROLOGUE(double, m_Engine->m_Job, m_Engine->m_Bounds)
	Mandelbar64(Width, Height, y1, y2, dy, RowDelta, Quality, 
...
void CEngine::CRenderer::MandelbarE3FPU()
{
	PROLOGUE(double, m_Engine->m_Job, m_Engine->m_Bounds)
	MAND_EXP_HDR
	zx = zx2 * zx - 3 * zx * zy2 + a;
	zy = zy2 * zy - 3 * zx2 * zy + b;
	MAND_EXP_FTR
}

void CEngine::CRenderer::MandelbarE4FPU()
{
	PROLOGUE(double, m_Engine->m_Job, m_Engine->m_Bounds)
	double	zx3, zy3, pzx;
	MAND_EXP_HDR
	...
	zy = 4 * pzx * zy3 - 4 * zx3 * zy + b;
	MAND_EXP_FTR
}

void CEngine::CRenderer::MandelbarE5FPU()
{
	PROLOGUE(double, m_Engine->m_Job, m_Engine->m_Bounds)
	...
	zy = 10 * zx2 * zy3 - 5 * zx4 * zy - zy4 * zy + b;
	MAND_EXP_FTR
}

void CEngine::CRenderer::MandelbarE6FPU()
{
	PROLOGUE(double, m_Engine->m_Job, m_Engine->m_Bounds)
	...
	zy = 20 * zx3 * zy3 - 6 * zx5 * zy - 6 * pzx * zy5 + b;
	MAND_EXP_FTR
}

void CEngine::CRenderer::MandelbarE7FPU()
{
	PROLOGUE(double, m_Engine->m_Job, m_Engine->m_Bounds)
	...
	zy = 35 * zx4 * zy3 - 7 * zx6 * zy - 21 * zx2 * zy5 + zy6 * zy + b;
	MAND_EXP_FTR
}

void CEngine::CRenderer::MandelbarE8FPU()
{
	PROLOGUE(double, m_Engine->m_Job, m_Engine->m_Bounds)
	...
	zy = 56 * zx5 * zy3 - 8 * zx7 * zy - 56 * zx3 * zy5 + 8 * pzx * zy7 + b;
	MAND_EXP_FTR
}

void CEngine::CRenderer::MandelbarE9FPU()
{
	PROLOGUE(double, m_Engine->m_Job, m_Engine->m_Bounds)
	...
	zy = 84 * zx6 * zy3 - 9 * zx8 * zy - 126 * zx4 * zy5 + 36 * zx2 * zy7 - zy8 * zy + b;
	MAND_EXP_FTR
}

void CEngine::CRenderer::MandelbarE10FPU()
{
	PROLOGUE(double, m_Engine->m_Job, m_Engine->m_Bounds)
	...
	zy = 120 * zx7 * zy3 - 10 * zx9 * zy - 252 * zx5 * zy5 + 120 * zx3 * zy7 - 10 * pzx * zy9 + b;
	MAND_EXP_FTR
}

void CEngine::CRenderer::MandelbarE11FPU()
{
	PROLOGUE(double, m_Engine->m_Job, m_Engine->m_Bounds)
	...
	zy = 165 * zx8 * zy3 - 11 * zx10 * zy - 462 * zx6 * zy5 + 330 * zx4 * zy7 - 55 * zx2 * zy9 + zy10 * zy + b;
	MAND_EXP_FTR
}

void CEngine::CRenderer::MandelbarE12FPU()
{
	PROLOGUE(double, m_Engine->m_Job, m_Engine->m_Bounds)
	...
	zy = 220 * zx9 * zy3 - 12 * zx11 * zy - 792 * zx7 * zy5 + 792 * zx5 * zy7 - 220 * zx3 * zy9 + 12 * pzx * zy11 + b;
	MAND_EXP_FTR
}

void CEngine::CRenderer::MandelbarE13FPU()
{
	PROLOGUE(double, m_Engine->m_Job, m_Engine->m_Bounds)
	...
	zy = 286 * zx10 * zy3 - 13 * zx12 * zy - 1287 * zx8 * zy5 + 1716 * zx6 * zy7 - 715 * zx4 * zy9 + 78 * zx2 * zy11 - zy12 * zy + b;
	MAND_EXP_FTR
}
