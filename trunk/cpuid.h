/*
		...
		revision history:
		rev		date	comments
        00      25apr08	removed apple-specific header
 
		x86 CPU indentification
...
// #include <sys/appleapiopts.h>	// ck: removed 04/25/08
 ...
 #define CPUID_CACHE_ICACHE_32K     0x /* Instruction cache, 32K, 8-way */
